 ...
 * @internal
 */
export interface AppConfigDataHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<AppConfigDataClientResolvedConfig, HandlerExecutionContext, AppConfigDataHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultAppConfigDataHttpAuthSchemeParametersProvider: (config: AppConfigDataClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<AppConfigDataHttpAuthSchemeParameters>;
/**
 * @internal
 */
